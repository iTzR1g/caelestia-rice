...
StyledRect {
    ...
    readonly property var quickToggles: {
        ...
        if (!seenIds.has("transparency"))
            toggles.push({ id: "transparency" });
    ...
    component QuickToggleRow: ButtonRow {
        ...
        Repeater {
            ...
            delegate: DelegateChooser {
                ...
                DelegateChoice {
                    roleValue: "transparency"
                    delegate: Toggle {
                        icon: "opacity"
                        checked: Hypr.options["decoration:active_opacity"] !== 1
                        onClicked: {
                            if (Hypr.options["decoration:active_opacity"] !== 1) {
